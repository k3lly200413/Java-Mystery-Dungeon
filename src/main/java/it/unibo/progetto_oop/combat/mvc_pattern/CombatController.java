...
public class CombatController {
    ...
    private void handleBackToMainMenu() {
        final CombatState newState = new PlayerTurnState();
    ...
    private void handleInfo() {
        final CombatState newState = new InfoDisplayState();
        newState.enterState(this);
                ...
                case 0 -> {
                    ...
                    if (this.neighbours.neighbours(
                        ...
                        if (this.neighbours.neighbours(
                            ...
                            System.err.println("Forcing state 1.");
                            state[0] = 1;
                        }
                    }
    ...
    public final boolean checkGameOver() {
        if (model.isGameOver()) {
            ...
            final String winner = model.getPlayerHealth() <= 0 ?
            "Enemy" : "Player";
